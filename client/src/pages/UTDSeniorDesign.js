        ...
        >
          ...
          <Grid item xs={12} md={9}>
            ...
            >
              ...
              information they need. Students will be able to form groups,
              submit weekly reports, and view project information. Sponsors will
              submit proposals and accompanying attachments, and faculty and
              mentors will be able to oversee and keep track of student progress
              and weekly reports. To do this we will be creating a web front-end
              with ReactJS that will provide users easy access to all
              information they need. The front-end will communicate with a SQL
              database, made using MySQL, and a Node.JS back-end. The resulting
              product will be a fully functioning secure website where students,
              faculty, and sponsors can access all the information they need to
          ...
          <Grid item xs={12} md={9}>
            ...
            >
              ...
              available and easily accessible. Students can use the student
              portal to join and form teams and edit them. Similarly to
              students, the company portal will allow companies to submit their
              project proposals, specify their requirements, and contact the
              faculty when necessary. Faculty will have administrative access
              and will be able to view all groups, their team members, and their
              assigned projects and can make changes as they see fit. As a
              result all three entities will be able to easily access all the
              information they need regarding the projects.
            </Typography>
          </Grid>
          <Grid item xs={12} md={9}>
            <Typography
            ...
            >
              ...
              priorities was to create a simple interface. Once we had the
              design planned, we started to explore React and Javascript. To
              design the website, we worked with ReactJS and Material UI.
            </Typography>
          </Grid>
          <Grid item xs={12} md={9} gutterBottom>
            <img
          ...
          <Grid item xs={12} md={9}>
            ...
            >
              ...
              display is switched to an appropriate Home Page for the user type.
              If the credentials are invalid, notify the user and allow a
              limited number of additional attempts. Permissions unlocked to
          ...
          <Grid item xs={12} md={9}>
            ...
            >
              ...
              powerpoints. The server will store these and assign the Project a
              unique identifier. Missing information should be reported back to
              the Sponsor and perhaps Admin.
            </Typography>
          </Grid>
          <Grid item xs={12} md={9}>
            <Typography
          ...
          <Grid item xs={12} md={9}>
            ...
            >
              ...
              Students can join an existing team or create a new team. The teams
              constantly update their statuses.
            </Typography>
          </Grid>
          <Grid item xs={12} md={9}>
            <Typography
            ...
            >
              ...
              take on. After teams have been assembled, they will have to rank
              the projects they’d preferred to be assigned to. Ranking is done
